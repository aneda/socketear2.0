...
class PackageSJQ(object):
    ...
    def __init__(self, device=None):
        ...
        self._info = "Package SJQ classifier.  VGG16 pretraining."
    ...
    def __call__(self, img, assign_label = True):
        ...
        I = np.zeros(shape = (8,3,220,220))
        I[0:1] = img.transpose(2,0,1)[None,:,:,:]
        I[1:2] = I[0:1,:,::-1,:]
        I[2:3] = I[0:1,:,:,::-1]
        I[3:4] = I[0:1,:,::-1,::-1]
        I[4:8] = I[0:4].transpose(0,1,3,2)
        prob = np.mean(self.prob_fn(I), axis = 0)
        if assign_label == False:
            return prob            
        else:
