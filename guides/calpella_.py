...
class Calpella(Pins):
    ...
    def __init__(self):
        df = pd.read_csv(join(self.data_path, '/home/mathew/Documents/experiments/experiments/mat/intel_stitching/Pattern/calpella_pack/calpella_pack_all.csv'))
        ...
        super(Calpella, self).__init__(pins, [200,200], 1)
