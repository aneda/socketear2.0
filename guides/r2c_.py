...
class R2c(Pins):
    ...
    def __init__(self):
        df = pd.read_csv(join(self.data_path, '/home/mathew/Documents/experiments/experiments/mat/intel_stitching/Pattern/SJR_1_pack/SJR_1_pack_all.csv'))
        ...
        super(R2c, self).__init__(pins, [200,200], 1)
